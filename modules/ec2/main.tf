...
# trigger can be used for detatched mode, when to to run 2 individuals servers
    ...
    provisioner "remote-exec" {
      ...
      inline = [
        ...
        "ansible-pull -i localhost, -U https://github.com/shivanandhan/Practice-roboshop-ansible roboshop.yml -e env=${var.env} -e component=${var.component_name} -e vault_token=${var.vault_token}"
      ]
    }
  }
